    ...
    <section>
        ...
        <table>
            ...
            <tr>
                ...
                <td><?php echo $rows['Weight(lbs)'];?></td>
                <td><?php echo $rows['Body Fat (%)'];?></td>
                <td><?php echo $rows['Bench Press (lbs)'];?></td>
                <td><?php echo $rows['Squat (lbs)'];?></td>
                <td><?php echo $rows['Vertical Jump'];?></td>
                <td><?php echo $rows['40-Yard Dash (seconds)'];?></td>
            </tr>
            <?php
                }
            ?>
